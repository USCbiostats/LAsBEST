...
Let's also create a dataset that doesn't have a difference in means. I'm going to do this by splitting the data into two random subsets of 50. I do this by shuffling ('permuting') the smoking values. 
